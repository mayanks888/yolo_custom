...
class Detect():
    def __init__(self, args_):
        ...
        self.output_path_crop = '/home/mayank_s/Desktop/output_path_crop_yolov4'
        self.bblabel = []
...
def main(args=None):
    ...
    parser.add_argument('--weights', type=str, default='/home/mayank_s/all_model_weight/yolov4_tl_weight/yolov4-custom_tl_best.weights', help='weights path')
